...
namespace Etbag\TrxpsPayments\Api\Exceptions;
...
class ApiException extends \Exception
{
     ...
     * @throws \Etbag\TrxpsPayments\Api\Exceptions\ApiException
     */
     ...
     * @param RequestInterface|null $request
     * @param \Throwable|null $previous
     * @return \Etbag\TrxpsPayments\Api\Exceptions\ApiException
     * @throws \Etbag\TrxpsPayments\Api\Exceptions\ApiException
     */
    ...
    protected static function parseResponseBody($response)
    {
        ...
        if (json_last_error() !== JSON_ERROR_NONE) {
            throw new self("Unable to decode Trxps response: '{$body}'.");
        }
